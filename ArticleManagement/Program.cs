...
builder.Services.AddDbContext<ArticleManagementContext>(options =>
...
else
{
    ...
    scope.ServiceProvider.GetRequiredService<ArticleManagementContext>().Database.Migrate();
}
...
//app.Run("http://178.251.42.243:5220");
