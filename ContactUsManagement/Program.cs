...
using ContactUsManagement.Services;
...
builder.Services.AddDbContext<ContactUsManagementContext>(options =>
...
else
{
    ...
    scope.ServiceProvider.GetRequiredService<ContactUsManagementContext>().Database.Migrate();
}
