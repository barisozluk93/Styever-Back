...
namespace UserManagement.Migrations
{
    ...
    [Migration("20260813213740_Initial")]
            ...
            modelBuilder.Entity("UserManagement.Entity.LegalContent", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Slug = "legal-warning",
                            SortOrder = 7,
                            Title = "YASAL UYARI VE SORUMLULUK REDDİ BEYANI",
                        ...
                        new
                        {
                            ...
                            SortOrder = 9,
                            Title = "MODERASYON POLİTİKASI VE İÇERİK DENETİMİ",
            ...
            modelBuilder.Entity("UserManagement.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2026, 8, 13, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3681),
                            Email = "admin@test.com",
                            ExpirationDate = new DateTime(2027, 8, 13, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3688),
                            IsActive = true,
                            IsDeleted = false,
                            IsSystemData = true,
                            IsTrial = false,
                            ...
                            Surname = "Admin",
                            TrialExpirationDate = new DateTime(2026, 8, 20, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3683),
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedDate = new DateTime(2026, 8, 13, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3714),
                            Email = "origin@test.com",
                            ExpirationDate = new DateTime(2027, 8, 13, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3715),
                            FileId = 1L,
                            IsActive = true,
                            IsDeleted = false,
                            IsSystemData = true,
                            ...
                            Salt = new byte[] { 3, 251, 182, 108, 1, 165, 5, 95, 117, 7, 42, 45, 196, 160, 190, 194, 65, 169, 48, 49, 99, 22, 120, 177, 165, 246, 57, 186, 94, 216, 59, 80, 48, 229, 210, 31, 5, 173, 219, 134, 83, 73, 90, 196, 220, 216, 163, 14, 219, 106, 52, 183, 13, 250, 15, 143, 154, 208, 85, 45, 29, 52, 13, 105 },
                            Surname = "User",
                            TrialExpirationDate = new DateTime(2026, 8, 20, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3714),
                            Username = "originuser"
                        },
                        new
                        {
                            Id = 3L,
                            CreatedDate = new DateTime(2026, 8, 13, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3723),
                            Email = "heart@test.com",
                            ExpirationDate = new DateTime(2027, 8, 13, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3723),
                            FileId = 2L,
                            IsActive = true,
                            IsDeleted = false,
                            IsSystemData = true,
                            ...
                            Salt = new byte[] { 3, 251, 182, 108, 1, 165, 5, 95, 117, 7, 42, 45, 196, 160, 190, 194, 65, 169, 48, 49, 99, 22, 120, 177, 165, 246, 57, 186, 94, 216, 59, 80, 48, 229, 210, 31, 5, 173, 219, 134, 83, 73, 90, 196, 220, 216, 163, 14, 219, 106, 52, 183, 13, 250, 15, 143, 154, 208, 85, 45, 29, 52, 13, 105 },
                            Surname = "User",
                            TrialExpirationDate = new DateTime(2026, 8, 20, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3723),
                            Username = "heartuser"
                        },
                        new
                        {
                            Id = 4L,
                            CreatedDate = new DateTime(2026, 8, 13, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3727),
                            Email = "family@test.com",
                            ExpirationDate = new DateTime(2027, 8, 13, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3728),
                            FileId = 3L,
                            IsActive = true,
                            IsDeleted = false,
                            IsSystemData = true,
                            ...
                            Salt = new byte[] { 3, 251, 182, 108, 1, 165, 5, 95, 117, 7, 42, 45, 196, 160, 190, 194, 65, 169, 48, 49, 99, 22, 120, 177, 165, 246, 57, 186, 94, 216, 59, 80, 48, 229, 210, 31, 5, 173, 219, 134, 83, 73, 90, 196, 220, 216, 163, 14, 219, 106, 52, 183, 13, 250, 15, 143, 154, 208, 85, 45, 29, 52, 13, 105 },
                            Surname = "User",
                            TrialExpirationDate = new DateTime(2026, 8, 20, 21, 37, 40, 93, DateTimeKind.Utc).AddTicks(3727),
                            Username = "familyuser"
                        });
                });
